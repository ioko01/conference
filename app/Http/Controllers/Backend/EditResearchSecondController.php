...
class EditResearchSecondController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Research::select(
            ...
            ->rightjoin('send_edit_words_two', 'researchs.topic_id', '=', 'send_edit_words_two.topic_id')
            ->rightjoin('send_edit_pdf_two', 'researchs.topic_id', '=', 'send_edit_pdf_two.topic_id')
            ->rightjoin('send_edit_statements_two', 'researchs.topic_id', '=', 'send_edit_statements_two.topic_id')
