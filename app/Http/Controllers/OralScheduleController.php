...
class OralScheduleController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.pages.oral_schedule', compact('present_orals', 'conference', 'faculties', 'colors', 'tips', 'textColors'));
    }
}
