...
class ResearchController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $data = Research::
                        ...
                        'slips.extension as slip_ext', 'words.extension as word_ext', 'pdf.extension as pdf_ext',
                        'slips.updated_at as slip_update', 'words.updated_at as word_update',
                        'pdf.updated_at as pdf_update', 'new_word', 'new_pdf', 'path_word', 'path_pdf',
