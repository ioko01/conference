...
class CreateSendEditStatementsTwoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('send_edit_statements_two', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('send_edit_statements_two');
    }
}
