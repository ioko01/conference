...
class CreatePostersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('posters', function (Blueprint $table) {
            ...
            $table->text('name')->nullable()->comment('ชื่อไฟล์ Poster');
            $table->text('path')->nullable()->comment('ที่อยู่ไฟล์ Poster');
            $table->string('extension')->nullable()->comment('นามสกุลไฟล์ Poster');
            $table->timestamps();
        });
    }
