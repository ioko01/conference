...
const open_modal_notice = (e, id, topic) => {
    const value = e.value;
    change_notice(value, id, topic);
};

const change_notice = (value, id, topic) => {
    ...
    data-bs-keyboard="true" tabindex="-1" aria-labelledby="ประชาสัมพันธ์" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/backend/download/notice/${id}/update" method="POST">
