...
const get_video = (type, topic_id, video_poster) => {
    ...
    if (video_poster) {
        ...
        btn_submit = `<button onclick="thisDisabled(this)" name="submit_${type}" value="${type}" type="submit" class="btn btn-warning text-white rounded-0">
        ...
        btn_submit = `<button onclick="thisDisabled(this)" name="submit_${type}" value="${type}" type="submit" class="btn btn-success rounded-0">
