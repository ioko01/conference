...
(function(window) {
    ...
    function lignePaginate() {
        ...
        var paginationMoreThatTenPage = function(iterator, numberOfPage) {
            ...
            let middleValue = `<span class='text-green'>...</span>`;
        ...
        var addGoToPage = function() {
            ...
            let goButton = "<input type='button' id='paginate-go-button' value='ไป' onclick='paginate.goToPage()'>  ";
        ...
        _lignePaginate.filter = function() {
            ...
            const trs = document.querySelectorAll(settings.el + ' tr:not(.pagination-header)');
