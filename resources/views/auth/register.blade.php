    ...
    <div class="col-md-5 tips">
        <div class="tips-content">
            <div class="tips-box py-5">
                <div class="icon"><img src="{{ asset('images/guide.png', env('REDIRECT_HTTPS')) }}" alt="guide-register">
                </div>
            ...
            <div class="tips-box py-5">
                <div class="icon"><img src="{{ asset('images/folder.png', env('REDIRECT_HTTPS')) }}" alt="guide-send"></div>
            ...
            <div class="tips-box py-5">
                <div class="icon"><img src="{{ asset('images/heart.png', env('REDIRECT_HTTPS')) }}" alt="guide"></div>
            ...
            <div class="tips-box py-5">
                <div class="icon"><img src="{{ asset('images/money-exchange.png', env('REDIRECT_HTTPS')) }}" alt=""></div>
