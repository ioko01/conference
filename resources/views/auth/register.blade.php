    ...
    <div id="register-content" class="bg-white text-blue p-5 my-5">
        ...
        @if (isset($conference_id->id))
            @if (endDate('end_research')->day < 0 && endDate('end_attend')->day < 0)
                <h1 class="text-danger text-center">หมดเวลาการลงทะเบียนแล้ว</h1>
            @else
                <div class="row w-100">
                    <div class="col-md-7">
                        <form action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="send">
                                                ลงทะเบียนส่งผลงาน <strong
                                                    class="text-red text-sm">(บุคคลภายนอกจะต้องชำระค่าลงทะเบียน 2,000 บาท
                                                    ต่อ 1 ผลงาน)</strong>
                                            </label>
                                        </div>
                                    @endif
                            ...
                            <div class="row mb-4">
                                <div class="col-12 @if (old('person_attend') == 'attend') d-none @endif" id="form_address">
                            ...
                            <div class="row mb-4">
                                <div class="col-12 @if (old('person_attend') == 'attend') d-none @endif" id="form_receive">
