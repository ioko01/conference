<!-- REQUIRED SCRIPTS -->
<!-- jQuery -->
<script src="{{ asset('vendor/plugins/jquery/jquery.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>

<script src="{{ asset('js/app.js?v=1.4', env('REDIRECT_HTTPS')) }}" defer></script>
<script src="{{ asset('js/main.js?v=1.4', env('REDIRECT_HTTPS')) }}" defer></script>

<!-- Bootstrap -->
<script src="{{ asset('vendor/plugins/bootstrap/js/bootstrap.bundle.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>

<!-- overlayScrollbars -->
<script
    src="{{ asset('vendor/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js?v=1.4', env('REDIRECT_HTTPS')) }}">
</script>

<script src="{{ asset('vendor/plugins/jquery-ui/jquery-ui.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
<!-- AdminLTE App -->
<script src="{{ asset('vendor/dist/js/adminlte.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
<script src="{{ asset('vendor/plugins/moment/moment.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
<script src="{{ asset('vendor/plugins/fullcalendar/main.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>

<script src="{{ asset('api/select-faculty.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
...
@if (Request::is('backend/researchs') ||
    ...
    <script src="{{ asset('api/manage-research.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif
...
<!-- ChartJS -->
<script src="{{ asset('vendor/plugins/chart.js/Chart.min.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>

{{-- <!-- AdminLTE for demo purposes -->
<script src="{{ asset('vendor/dist/js/demo.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script> --}}
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
{{-- <script src="{{ asset('vendor/dist/js/pages/dashboard2.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script> --}}

@if (Request::is('backend/user/*/edit'))
    <script src="{{ asset('js/select-kota.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('js/select-attend.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif

@if (Request::is('backend/conference') || Request::is('backend/conference/*/edit'))
    <script src="{{ asset('js/get-start-end-datetime-local.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif
...
@if (Request::is('backend/download/*/edit') ||
    ...
    <script src="{{ asset('js/toggle-file-link.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('api/change-notice.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif
...
@if (Request::is('backend/poster/*/edit') ||
    ...
    <script src="{{ asset('api/delete.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif

@if (Request::is('backend/lines') || Request::is('backend/line/*/edit'))
    <script src="{{ asset('js/line-detail-modal.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
...
@if (Request::is('backend/orals/link') ||
        ...
        Request::is('backend/posters/link') ||
        Request::is('backend/posters/link/*/edit'))
    <script src="{{ asset('js/oral-detail-modal.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('js/default-modal.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif
...
@if (Request::is('backend/proceeding/*/research') ||
        ...
        Request::is('backend/researchs/passed'))
    <script src="{{ asset('vendor/plugins/datatables/datatables.min.js?v=1.4', env('REDIRECT_HTTPS')) }}" defer></script>
    <script>
...
@if (Request::is('backend/dashboard'))
    <script src="{{ asset('api/calendar.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('js/calendar.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('js/highcharts.js?v=1.4', env('REDIRECT_HTTPS')) }}" charset="utf-8"></script>
    {!! $chart->script() !!}
...
@if (Request::is('backend/researchs/management') || Request::is('backend/users'))
    <script src="{{ asset('js/suggestion-detail-modal.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script src="{{ asset('js/default-modal.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
    <script>
...
@if (Request::is('backend/researchs/management/times/1') || Request::is('backend/researchs/management/times/2'))
    <script src="{{ asset('vendor/plugins/quill/quill.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
@endif

<script src="{{ asset('vendor/plugins/sweetalert2/sweetalert2.all.js?v=1.4', env('REDIRECT_HTTPS')) }}"></script>
