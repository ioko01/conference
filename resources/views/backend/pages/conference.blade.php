                    ...
                    <tbody>
                        ...
                        <tr class="text-xs"
                            ...
                            <th><a href="{{ route('backend.conference.edit', ['conference_id' => $conference->id]) }}"
                                    class="text-primary"><i class="fas fa-pen"></i> แก้ไข</a></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="text-xs">วันเริ่ม - สิ้นสุดงานประชุมวิชาการ <br /><span
                                    class="text-red">(ต้องเปิดหัวข้อนี้ก่อนถึงจะเปิดใช้งานหัวข้ออื่นได้)</span></th>
                            <td colspan="2" class="text-left text-xs">{{ thaiDateFormat($conference->start) }} - {{
                                thaiDateFormat($conference->final) }}</td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    @csrf
                                    @method('PUT')
                                    <div class="custom-control custom-switch">
                                        <input
                                            ...
                                            id="switch_conference_{{ $key }}" @if($conference->status == 1) checked
                                        @endif>
                                    ...
                                    <input type="submit" class="d-none" id="change_conference_{{ $key }}"
                                        name="change_status_conference" @if($conference->status == 1) value=0 @else
                                    value=1 @endif>
                                </form>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{ thaiDateFormat($conference->start_research)
                                ...
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input
                                            ...
                                            type="checkbox" class="custom-control-input" id="switch_research_{{ $key }}"
                                    ...
                                    <input type="submit" class="d-none" id="change_research_{{ $key }}"
                                        name="change_status_research" @if($conference->status_research == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{ thaiDateFormat($conference->end_payment) }}
                            </td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input
                                            ...
                                            type="checkbox" class="custom-control-input" id="switch_payment_{{ $key }}"
                                    ...
                                    <input type="submit" class="d-none" id="change_payment_{{ $key }}"
                                        name="change_status_payment" @if($conference->status_payment == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{ thaiDateFormat($conference->end_attend) }}
                            </td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input
                                            ...
                                            type="checkbox" class="custom-control-input" id="switch_attend_{{ $key }}"
                                    ...
                                    <input type="submit" class="d-none" id="change_attend_{{ $key }}"
                                        name="change_status_attend" @if($conference->status_attend == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{
                                thaiDateFormat($conference->end_research_edit) }}</td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    @csrf
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input
                                            ...
                                            type="checkbox" class="custom-control-input"
                                            id="switch_research_edit_{{ $key }}" @if($conference->status_research_edit
                                        == 1) checked @endif>
                                    ...
                                    <input type="submit" class="d-none" id="change_research_edit_{{ $key }}"
                                        name="change_status_research_edit" @if($conference->status_research_edit == 1)
                                    value=0
                                    @else
                                    value=1 @endif>
                                </form>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{
                                thaiDateFormat($conference->end_research_edit_two) }}</td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    @csrf
                                    ...
                                    <input type="submit" class="d-none" id="change_research_edit_two_{{ $key }}"
                                        name="change_status_research_edit_two" @if($conference->status_research_edit_two
                                    == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{
                                thaiDateFormat($conference->end_poster_and_video) }}</td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    @csrf
                                    ...
                                    <input type="submit" class="d-none" id="change_poster_and_video_{{ $key }}"
                                        name="change_status_poster_and_video" @if($conference->status_poster_and_video
                                    == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left text-xs">{{
                                thaiDateFormat($conference->end_poster_and_video_two) }}</td>
                            <td>
                                <form method="POST" action="{{ route('backend.conference.update_status', $conference->id) }}"
                                    class="d-flex">
                                    @csrf
                                    ...
                                    <input type="submit" class="d-none" id="change_poster_and_video_two_{{ $key }}"
                                        name="change_status_poster_and_video_two"
                                        @if($conference->status_poster_and_video_two
                                    == 1) value=0
                                    @else
                                    value=1 @endif>
                                </form>
