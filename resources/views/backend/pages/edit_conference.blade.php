                ...
                <form method="POST" action="{{ route('backend.conference.update_topic', $conference->id) }}" class="mb-3">
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input onchange="get_min_date_value(this)"
                                value="{{ date('Y-m-d\TH:i', strtotime($conference->start)) }}" type="datetime-local"
                                name="start" id="start"
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input onchange="get_max_date_value(this)"
                                value="{{ date('Y-m-d\TH:i', strtotime($conference->final)) }}" type="datetime-local"
                                name="final" id="final"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_research)) }}"
                                type="datetime-local" name="end_research" id="end_research"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_payment)) }}"
                                type="datetime-local" name="end_payment" id="end_payment"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->consideration)) }}"
                                type="datetime-local" name="consideration" id="consideration"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_research_edit)) }}"
                                type="datetime-local" name="end_research_edit" id="end_research_edit"
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            <label for="end_research_edit_two">วันสิ้นสุดการรับบทความแก้ไขหลังนำเสนอ <span
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input
                                @if ($conference->end_research_edit_notice_1) value="{{ date('Y-m-d\TH:i', strtotime($conference->end_research_edit_notice_1)) }}" @endif
                                type="datetime-local" name="end_research_edit_notice_1" id="end_research_edit_notice_1"
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input
                                @if ($conference->end_research_edit_notice_2) value="{{ date('Y-m-d\TH:i', strtotime($conference->end_research_edit_notice_2)) }}" @endif
                                type="datetime-local" name="end_research_edit_notice_2" id="end_research_edit_notice_2"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_attend)) }}"
                                type="datetime-local" name="end_attend" id="end_attend"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_poster_and_video)) }}"
                                type="datetime-local" name="end_poster_and_video" id="end_poster_and_video"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->notice_attend)) }}"
                                type="datetime-local" name="notice_attend" id="notice_attend"
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->present)) }}"
                                type="datetime-local" name="present" id="present"
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->proceeding)) }}"
                                type="datetime-local" name="proceeding" id="proceeding"
                                class="form-control rounded-0 @error('proceeding') is-invalid @enderror">
                            @error('proceeding')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
