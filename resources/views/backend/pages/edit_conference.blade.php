                ...
                <form method="POST" action="{{ route('backend.conference.update_topic', $conference->id) }}" class="mb-3">
                    ...
                    <div class="row m-0">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->start_research)) }}"
                                type="datetime-local" name="start_research" id="start_research"
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_research_edit_two)) }}"
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <input value="{{ date('Y-m-d\TH:i', strtotime($conference->end_poster_and_video_two)) }}"
                                type="datetime-local" name="end_poster_and_video_two" id="end_poster_and_video_two"
