...
@section('content')
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('backend.poster.link.store') }}"
                    class="mb-3">
                    @csrf
                    <div class="row">
                        ...
                        <tbody>
                            @forelse ($link_posters as $key => $link_poster)
                                <tr>
                                    ...
                                    <td class="text-right"><a href="{{ route('backend.poster.link.edit', $link_poster->id) }}"
                                            class="btn btn-sm text-white btn-warning rounded-0"><i class="fa fa-edit"></i>
                                            แก้ไข</a>
                                    </td>
                                    <td><button
                                            onclick="open_modal('{{ $link_poster->room }}', '{{ route('backend.poster.link.delete', $link_poster->id) }}')"
