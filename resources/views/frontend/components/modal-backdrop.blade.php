@section('modal')
    ...
    @foreach ($data as $value)
        <div class="modal fade" id="payment-modal-example" data-bs-backdrop="static" data-bs-keyboard="true"
            tabindex="-1" aria-labelledby="ตัวอย่างการชำระเงิน" aria-hidden="true">
    ...
    @foreach ($data as $value)
        <form enctype="multipart/form-data" method="POST"
            action="{{ route('employee.file-upload.update', ['file_upload' => $value->topic_id]) }}"
    ...
    @foreach ($data as $value)
        <form enctype="multipart/form-data" method="POST"
            ...
            id="word-modal" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
