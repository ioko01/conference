@extends('frontend.components.button_to_top')
@section('content')
<!-- Poster -->
<header id="poster1">
    <img src="./image/banner-01.jpeg" alt="banner" width="100%">
</header>

<div id="poster2" style="padding: 10rem 0 10rem 0" class="container">
    <div class="row m-0">
        <div class="col-6">
            <img src="./image/banner1-v2.1.png" alt="banner" width="100%">
        </div>
        <div class="col-6">
            <img src="./image/Poster-eddit.png" alt="banner" width="100%">
        </div>
    </div>
</div>
<!-- End Poster -->
    ...
    <div class="row justify-content-center m-0">
        <div style="opacity: .8;" class="col-md-10 bg-white p-5 w-100">
            ...
            <p>&emsp;การเปลี่ยนแปลงที่เกิดจากโลกาภิวัตน์ในทศวรรษที่ผ่านมาส่งผลกระทบในวงกว้างต่อคนทั้งโลก
                ...
                เกิดจากการผลักดันสองแนวคิดแรก บนฐานการอนุรักษ์สิ่งแวดล้อม และทรัพยากรธรรมชาติ เพื่อสร้างคุณภาพชีวิตที่ดี
                สิ่งแวดล้อมที่ดีอย่างยั่งยืนต่อไป
                <br />&emsp; สถาบันการศึกษาจึงเป็นกลไกหนึ่งที่มีส่วนช่วยในการสร้าง และพัฒนาต่อยอดองค์ความรู้
                เพื่อหนุนเสริมแนวคิดที่กล่าวมาข้างต้น ไม่ว่าจะเป็นการค้นคว้าวิจัย เพื่อสร้างเทคโนโลยีและนวัตกรรมพร้อมใช้
                ...
                Conference 2022 ขึ้น เพื่อเป็นเวทีในการนำเสนอผลงานวิชาการโดยแบ่งกลุ่มนำเสนอผลงานออกเป็น 5 กลุ่ม คือ 1)
                กลุ่มมนุษยศาสตร์/สังคมศาสตร์
                2) กลุ่มครุศาสตร์ 3) กลุ่มวิทยาศาสตร์และเทคโนโลยี 4) กลุ่มบริหารธุรกิจ บริการ และการท่องเที่ยว และ 5)
            ...
            <p>1. การนำเสนอผลงานในรูปแบบบรรยาย (Oral Presentation) ใช้เวลาในการนำเสนอ เรื่องละไม่เกิน 20 นาที (รวมซักถาม
                5 นาที) รูปแบบการจัดทำบทความฉบับเต็ม (Full Paper) สามารถดาวน์โหลดได้ที่ https://conference.lru.ac.th/
            </p>
            <p>2. การนำเสนอผลงานวิจัยในรูปแบบโปสเตอร์ (Poster Presentation) กว้าง 80 ซม. X สูง 120 ซม.
                ...
                (จัดให้อยู่กึ่งกลางหน้ากระดาษ)<br /> 3) บทนำ<br /> 4) วัตถุประสงค์<br /> 5) วิธีดำเนินการวิจัย<br /> 6)
                ...
                เป็นผลงานใหม่ที่ยังไม่เคยเผยแพร่ที่ใดมาก่อน<br /> 2. มีหัวข้อเกี่ยวข้องกับสาขาวิชาต่าง ๆ ดังนี้<br /> 1)
                ...
                <strong style="color: brown;">การเตรียมบทความวิจัย/วิทยานิพนธ์</strong><br /> ความยาวไม่เกิน 7-12 หน้า
                ...
                <strong style="color: brown;">การเตรียมบทความวิชาการ</strong><br /> ความยาวไม่เกิน 7-12 หน้า ชนิดอักษร
            ...
            <p>1. การส่งต้นฉบับ ผู้นำเสนอจะต้องส่งต้นฉบับแบบพิมพ์ในรูปแบบของอิเล็กทรอนิกส์ไฟล์นามสกุล “.doc” (MS Word)
            ...
            <p>1. พิจารณาการเลือกกลุ่มการนำเสนอผลงานและประเภทของการนำเสนอผลงาน<br /> 2.
                ...
                โดยกรรมการผู้ทรงคุณวุฒิร่วมประเมินผลงานที่นำเสนอทั้งภาคบรรยาย (Oral Presentation) และภาคโปสเตอร์ (Poster
                Presentation)
            </p>
            ...
            <p>1. ผลงานที่ตีพิมพ์ในรายงานสืบเนื่องจากการประชุมวิชาการระดับชาติ
                ...
                สำหรับผู้เข้าร่วมการนำเสนอผลงานทุกท่านจะได้รับเกียรติบัตรการนำเสนอผลงาน ซึ่งสามารถดาวน์โหลดได้ผ่านทาง
