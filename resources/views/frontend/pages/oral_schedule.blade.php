        ...
        @if (isset($conference->status_present_oral) && $conference->status_present_oral == 1)
            @if (count($present_orals) > 0)
                <div class="inner-content-header">
                    <h4 class="text-center">กำหนดการนำเสนอ Oral Presentation <br />
                        @if ($conference)
                            {{ $conference->name }}
                        @endif
                    </h4>
                ...
                <div>
                    <h1>กำหนดการการนำเสนอผลงาน Oral Presentation</h1>
                    <a href="/orals/link" class="h1 text-green"> >> คลิ๊กที่นี่เพื่อตรวจสอบห้องนำเสนอผลงาน Oral Presentation <<</a>
                </div>
            ...
            @else
                <h1 class="text-danger text-center">
                    ...
                    <strong style="font-size: calc(.5vw + 10px);">
                        ไม่มีกำหนดการนำเสนอ Oral Presentation
                    </strong>
                </h1>
            @endif
        @else
