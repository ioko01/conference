        ...
        <div class="col-md-7">
            <form action="{{ route('employee.research.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="topic_th" name="topic_th" value="{{ old('topic_th') }}" class="form-control @error('topic_th')
                        is-invalid                        
                    @enderror" autocomplete="topic_th" autofocus>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="topic_en" name="topic_en" value="{{ old('topic_en') }}" class="form-control @error('topic_en')
                        is-invalid
                    @enderror" autocomplete="topic_en">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <span>1.&nbsp;</span>
                        <input type="text" id="presenters[]" name="presenters[]" class="form-control w-100 @error('presenters.0')
                            is-invalid
                        @enderror" value="{{ old('presenters.0') }}" autocomplete="presenters[0]">
                ...
                <div class="mb-4">
                    ...
                    <select name="faculty_id" id="faculty_id" class="form-select @error('faculty_id')
                        is-invalid
                    @enderror" onchange="select_faculty(this)">
                ...
                <div class="mb-4">
                    ...
                    <select name="branch_id" id="branch_id" class="form-select @error('branch_id')
                        is-invalid
                    @enderror" @if (!old('faculty_id')) disabled @endif>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="present_id" id="present_{{ $present->id }}"
                            value="{{ $present->id }}" @if (!old('present_id')) @if ($present->id ==
                        $presents->first()->id)
                        checked
                        @endif
        ...
        <div class="col-md-5 tips">
            <div class="tips-content">
                ...
                <div class="tips-box py-5">
                    <div class="icon"><img src="{{ asset($tip->image, env('REDIRECT_HTTPS')) }}" alt="{{ $tip->head }}">
                    </div>
                    <div class="content"><strong>{{ $tip->head }}</strong><br /><span><textarea readonly
                                style="width: 100%;" class="txt-tips autosize">{{ $tip->detail }}</textarea></span>
                    </div>
                </div>
                @endforeach
            </div>
