@section('script')
    <!-- Scripts -->
    <script src="{{ asset('js/jquery-3.6.0.min.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    ...
    <script src="{{ asset('js/animate.js?v=4', env('REDIRECT_HTTPS')) }}" defer></script>

    @if (Request::is('employee/research/show/*'))
        <script src="{{ asset('js/preview-image-payment.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    @endif

    @if (Request::is('/'))
        <script src="{{ asset('api/countdown.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    @endif
    ...
    @if (Request::is('employee/research/show/*') ||
        ...
        <script src="{{ asset('api/send-edit-upload-research.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    @endif
    ...
    @if (Request::is('register'))
        <script src="{{ asset('js/show-hide-password.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    ...
    @if (Request::is('employee/research/uploadfile/*'))
        <script src="{{ asset('api/upload-video-poster.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
        <script src="{{ asset('js/default-modal.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
        <script src="{{ asset('js/upload-poster-detail-modal.js?v=4', env('REDIRECT_HTTPS')) }}"></script>
    @endif
