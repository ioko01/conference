                    ...
                    <div class="row justify-content-center m-0 px-3">
                        ...
                        <div style="word-wrap: break-word;" class="col-md-10 w-100 rounded-0">
                            ...
                            <p style="line-height: 25px;">
                                ...
                                ความซับซ้อนสูง (Complexity) และความคลุมเครือยากที่จะคาดเดา (Ambiguity) หรือที่เรียกันว่า
                                ...
                                จะได้ใช้เวทีนี้ในการแลกเปลี่ยนความรู้ &emsp;และต่อยอดงานวิจัยเพื่อประโยชน์ต่อสังคมโดยรวมต่อไป
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center m-0 p-5">
                        <div style="word-wrap: break-word;" class="col-md-10 w-100 rounded-0 px-3">
                            ...
                            <p style="line-height: 25px;">
                                ...
                                ซึ่งสามารถดาวน์โหลดได้ผ่านทาง https://conference.lru.ac.th/ ตั้งแต่วันที่ 1 เมษายน 2566
                                เป็นต้นไป
                            </p>
                        </div>
                    </div>
